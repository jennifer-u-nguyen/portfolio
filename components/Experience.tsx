        ...
        <section id="experience" className="py-24">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="space-y-16">
                    {/* Industry Section */}
                    <div>
                        <h3 className="text-xl font-semibold mb-8 text-foreground/80 flex items-center gap-3">
                            <span className="h-1 w-6 bg-primary/40 rounded-full" />
                            Industry
                        </h3>
                        <div className="relative border-l border-border/60 ml-3 md:ml-6 space-y-12">
                            {EXPERIENCE.industry.map((job, index) => (
                    ...
                    <div>
                        ...
                        <div className="relative border-l border-border/60 ml-3 md:ml-6 space-y-12">
                            {EXPERIENCE.research.map((job, index) => (
                                <div key={index} className="relative pl-8 md:pl-12">
                                    <span className="absolute left-[-5px] top-2 h-2.5 w-2.5 rounded-full bg-primary ring-4 ring-background" />
