...
export const PROJECTS = [
  ...
  },
  {
    ...
    tags: ["SOLIDWORKS", "GD&T", "DFM", "DFA", "Materials Selection"],
  ...
  },
  {
    ...
    tags: ["SOLIDWORKS", "Gcode", "Waterjet", "Bandsaw", "Drill Press"],
  ...
  },
  {
    ...
    tags: ["Bandsaw", "Soldering", "Electronics", "Lasercutter"],
    problem: "Needed a reactive dance floor that randomly generates new tiles for the user to select and tracks metrics such as reaction time, score, and game length.",
